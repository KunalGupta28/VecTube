...
(
    ...
    docker buildx build --platform linux/arm64,linux/amd64 --tag ifelsedotone/vectube-web:latest --tag ifelsedotone/vectube-web:$version . --push 2>&1 | tee "../$WEB_LOG"
) &  # Run in background
...
(
    ...
    docker buildx build --platform linux/arm64,linux/amd64 --tag ifelsedotone/vectube-engine:latest --tag ifelsedotone/vectube-engine:$version . --push 2>&1 | tee "../$ENGINE_LOG"
) &  # Run in background
